...
$total_bookings = getTotalBookingsStudent($conn, $student_id);

// Fetch bookings with pagination
$bookings = getAllBookingsByStudentId($conn, $student_id);
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="<?= $base_url ?>/bookingDetail?id=<?php echo $row['booking_id']; ?>">View</a></li>
