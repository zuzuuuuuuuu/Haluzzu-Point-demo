...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <script src="students/lib/chart/chart.min.js"></script>
            <script src="students/lib/easing/easing.min.js"></script>
            <script src="students/lib/waypoints/waypoints.min.js"></script>
            <script src="students/lib/owlcarousel/owl.carousel.min.js"></script>
            <script src="students/lib/tempusdominus/js/moment.min.js"></script>
            <script src="students/lib/tempusdominus/js/moment-timezone.min.js"></script>
            <script src="students/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
