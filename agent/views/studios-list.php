...
$total = getTotalStudiosAgent($conn, $agent_id);

// Fetch studios with pagination
$studios = getAllStudioAgent($conn, $limit, $offset, $agent_id);
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="<?= $base_url; ?>/<?= $user_type; ?>/studioCreate">
                                    <div class="btn btn-primary mb-4">Create Studio</div>
                                </a>
                            </div>
