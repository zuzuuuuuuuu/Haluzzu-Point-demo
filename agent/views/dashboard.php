...
$agent_data = getAgentByUserId($conn, $_SESSION['user_id']);
$agent_id = $agent_data['agent_id'] ?? null; // Use null if 'agent_id' is not found

$sales_data = getMonthlySalesByAgent($conn, $agent_id);
$sales = $sales_data['sales'];
$months = $sales_data['months'];

$sales_state_data = getSalesByStateByAgent($conn, $agent_id);
$states = $sales_state_data['states'];
$total_rents = $sales_state_data['total_rents'];
$bookings = getAllBookingByAgentButLimit($conn, $agent_id, 10);
...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <?php // include 'agent/views/components/spinner.php'; 
        ?>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0">RM<?= getTodaySalesByAgent($conn, $agent_id); ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0">RM<?= getTotalSalesByAgent($conn, $agent_id); ?></h6>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?= getTotalStudiosByAgent($conn, $agent_id); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
